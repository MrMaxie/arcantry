...
description: Audit and update user, repository, nested, or private agent guidance through exact approval-gated proposals. Use when AGENTS.md instructions are missing, conflicting, misplaced, stale, or too broad.
---
...
6. Validate nesting, language, commands, privacy boundaries, and managed-section ownership.
