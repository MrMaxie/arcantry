...
Validate content and functionality at representative intermediate widths, at a 320 CSS pixel reflow equivalent, with user text-spacing overrides, and with keyboard and screen-reader navigation. The live preview may move after the questions when parallel placement no longer preserves readable lines. A separate 200 percent text-resize check remains deferred private work rather than a gate for this change.
