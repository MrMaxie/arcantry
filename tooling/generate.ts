...
for (const entry of catalog.skills) {
  ...
  catalogCards.set(
    ...
    [
      ...
      `  <h3><a href="/arcantry/skills/${entry.name}/">${escapeHtml(agent.displayName)}</a></h3>`,
